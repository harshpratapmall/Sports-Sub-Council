...
<body>
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <!-- Single Slide -->
            <div class="single-welcome-slide bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/home-bg2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <!-- Welcome Text -->
                        <div class="col-12">
                            <div class="welcome-text text-right">
                                <h2 data-animation="fadeInUp" data-delay="300ms">RANN NEETI <br>2k19</h2>
                                <h6 data-animation="fadeInUp" data-delay="500ms">IIT MANDI, HIMACHAL</h6>
                                <div class="hero-btn-group" data-animation="fadeInUp" data-delay="700ms">
                                    <a href="about.html" class="btn confer-btn">About Us <i class="zmdi zmdi-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Single Slide -->
            <div class="single-welcome-slide bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/home-bg.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <!-- Welcome Text -->
                        <div class="col-12">
                            <div class="welcome-text-two text-center">
                                <h5 data-animation="fadeInUp" data-delay="100ms">GRAB THE GOLD</h5>
                                <h2 data-animation="fadeInUp" data-delay="300ms">RANN NEETI</h2>
                                <!-- Event Meta -->
                                <div class="event-meta" data-animation="fadeInUp" data-delay="500ms">
                                    <a class="event-date" href="#"><i class="zmdi zmdi-account"></i> October 11-13, 2019</a>
                                    <a class="event-author" href="#"><i class="zmdi zmdi-alarm-check"></i> IIT MANDI</a>
                                </div>
                                <div class="hero-btn-group" data-animation="fadeInUp" data-delay="700ms">
                                    <a href="#" class="btn confer-btn m-2">View more <i class="zmdi zmdi-long-arrow-right"></i></a>
                                    <a href="register.php" class="btn confer-btn m-2">Register <i class="zmdi zmdi-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="about-content-text mb-80">
                        <h6 class="wow fadeInUp" data-wow-delay="300ms">About Rann Neeti</h6>
                        <h3 class="wow fadeInUp" data-wow-delay="300ms">welcome to RANN NEETI</h3>
                        <p class="wow fadeInUp" data-wow-delay="300ms">Let me guess you are an awesome sportsperson, won a lot of tournaments, think you are better than everyone? Think Again. IIT Mandi presents to you the 6th Edition of the most power packed, fiery and competitive sports event of the north, Rann-Neeti. Compete to prove that you have what it takes to be called a champion. <br><br>
                                
                                RannNeeti not only serves as a competitive platform but also a platform where a person may develop his own skills and grow as a better sportsperson.</p>
                        <a href="register.php" class="btn confer-btn mt-50 wow fadeInUp" data-wow-delay="300ms">Register <i class="zmdi zmdi-long-arrow-right"></i></a>
                    </div>
                </div>
    ...
    <section class="about-us-countdown-area section-padding-100-0" id="about" style="padding-bottom: 50px; background-color: rgb(14, 39, 61);">
        <div class="container">
            <div class="col-12 col-md-6">
                    <div class="about-content-text mb-80">
                        <h3 class="wow fadeInUp" data-wow-delay="300ms">PRONITES</h3>
                    </div>
                </div>
            <div class="container">
                <div class="row align-items-center">
                    <!-- About Content -->
                            <img src="img/pronites/bingo.png" alt="" style="padding: 10px;">
    
                    <!-- About Thumb -->
                                <img src="img/pronites/local.png" alt="" style="padding: 10px;">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="section-heading text-center wow fadeInUp" data-wow-delay="300ms">
                        <h5 style="color: white">OUR EVENTS</h5>
                        <h4>A glance</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/cricket-min.jpg.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/baddy2.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/chess.jpg" alt="chess">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/volly-min.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/lawntennis.jpg" alt="lawn tennis">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/football.jpg" alt="football">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/tt-min.jpg" alt="tt">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/basketball.jpg" alt="basketball">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-speaker-area bg-gradient-overlay-2 wow fadeInUp" data-wow-delay="300ms">
                        <!-- Thumb -->
                        <div class="speaker-single-thumb">
                            <img src="img/bg-img/athletics.jpg" alt="athletics">
                        </div>
                ...
                <div class="col-12">
                    <div class="more-speaker-btn text-center mt-20 mb-40 wow fadeInUp" data-wow-delay="300ms">
                        <a class="btn confer-btn-white" href="schedule.html">view Fixtures<i class="zmdi zmdi-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="our-schedule-area section-padding-100" style="background: url(./img/bg-img/schedule-bg.jpg); backface-visibility: 0;">
        <div class="container">
            <div class="row">
                <!-- Heading -->
                <div class="col-12" style="height: auto;">
                    <div class="section-heading-2 text-center wow fadeInUp" style="height: auto" data-wow-delay="300ms">
                        <p>Our Timetable</p>
                        <h4>Schedule Plan</h4>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="more-schedule-btn text-center mt-50 wow fadeInUp" data-wow-delay="300ms">
                                            <a href="schedule.html" class="btn confer-gb-btn">Open schedule's page</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="our-sponsor-area d-flex flex-wrap">
                                ...
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                                    <a href="https://www.niviasports.com/"><img src="img/core-img/nivia.png" alt=""></a>
                                </div>
                                <!-- Single Sponsor -->
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                                    <a href="https://dukeindia.com/"><img src="img/core-img/duke-logo.png" alt=""></a>
                                </div>
                                <!-- Single Sponsor -->
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                                    <a href="https://www.indiamart.com/festee/"><img src="img/core-img/festee-logo.jpg" alt=""></a>
                                </div>
                                <!-- Single Sponsor -->
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                                    <a href="http://www.furnitureashoka.com/home/"><img src="img/core-img/ashoka-logo.png" alt=""></a>
                                </div>
                                <!-- Single Sponsor -->
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                                    <a href="https://www.facebook.com/rattanjewellers.indramarket/"><img src="img/core-img/rattan-logo.jpg" alt=""></a>
                                </div>
                                <!-- Single Sponsor -->
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                                    <a href="#"><img src="img/core-img/paras-logo.jpg" alt=""></a>
                                </div>
                                <!-- Single Sponsor -->
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                                    <a href="http://bingosnacks.com/comedy-adda/"><img src="img/core-img/bingo-adda-logo.png" alt="Entertainment Partners">
                                    </a>
                                </div>
                                <!-- Single Sponsor -->
                                <div class="single-sponsor wow fadeInUp" data-wow-delay="300ms">
                ...
                <div class="col-12 col-sm-3">
                    <div class="contact-information mb-100">
                        ...
                        <div class="single-contact-info wow fadeInUp" data-wow-delay="300ms">
                            <p>Address:</p>
                            <h6>IIT MANDI, HIMACHAL PRADESH</h6>
                        </div>
                        <!-- Single Contact Info -->
                        <div class="single-contact-info wow fadeInUp" data-wow-delay="300ms">
                            <p>Phone:</p>
                            <h6>99172 48334 <br>94614 06697 </h6>
                        </div>
                        <!-- Single Contact Info -->
                        <div class="single-contact-info wow fadeInUp" data-wow-delay="300ms">
                            <p>Email:</p>
                            <h6>public_relations@rann-neeti.co</h6>
                        </div>
                ...
                <div class="col-12 col-sm-8">
                    ...
                    <div class="contact_from_area mb-100 clearfix wow fadeInUp" data-wow-delay="300ms">
                        <div class="contact_form">
                            <form action="https://formspree.io/public_relations@rann-neeti.co" method="post" id="main_contact_form">
    ...
    <!-- Map Area -->
    <div class="map-area" style="border: rgb(99, 3, 99) solid 5px">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script>
            ...
            var countDownDate = new Date("Oct 11, 2019 00:00:01").getTime();
            ...
            var x = setInterval(function() {
              ...
              document.getElementById("clock").innerHTML = "<div>"+days+ "<span>Days</span></div> <div>"+hours +"<span>Hours</span></div> <div>"+minutes+ "<span>Minutes</span></div> <div>"+seconds+ "<span>Seconds</span></div>";
                
              // If the count down is over, write some text 
              if (distance < 0) {
                clearInterval(x);
                document.getElementById("clock").innerHTML = "Game has Started";
              }
            }, 1000);
    </script>
